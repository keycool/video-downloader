...
description: 使用 yt-dlp 下载视频，支持画质选择、字幕下载、仅音频模式，自动判断语言并添加中文字幕
---

# 视频下载器 (Video Downloader)

使用 yt-dlp 工具下载网络视频，支持 YouTube、Bilibili、Twitter 等主流平台。**自动判断视频语言：非中文（普通话/粤语）视频将自动添加中文字幕。**
